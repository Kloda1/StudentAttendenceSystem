...
<head>
    ...
    <title>
        <?php echo $__env->yieldContent('title', __('student.student_dashboard')); ?>
        - <?php echo e(__('student.university_name')); ?>
    ...
    <aside class="w-64 bg-gradient-to-b from-blue-700 to-blue-900 text-white p-6 flex flex-col">
        ...
        <div class="text-center mb-8">
            ...
            <p class="text-sm opacity-80 mt-1">
                <?php echo e(__('student.greeting')); ?>
...
<?php /**PATH C:\Users\DELL\Desktop\LARAVEL\StudentAttendenceSystem\resources\views/student/layout.blade.php ENDPATH**/ ?>